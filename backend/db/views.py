...
from .models import Profile, Inventory, ReorderThreshold, Notifications, Dashboard, InventoryHistory, AuditTrail, OrderItem, Customer, CustomerOrder, \
    Shipment, PurchaseOrder, ForecastingPreferences, Supplier, SupplierOrder, Category
from .serializers import ProfileSerializer, InventorySerializer, ReorderThresholdSerializer, NotificationsSerializer, DashboardSerializer, AuditTrailSerializer, \
